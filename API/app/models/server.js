...
class Server {
    ...
    constructor() {
        ...
        this.equivalenciaPath = '/api/equivalencia';
        this.retornoPath = '/api/retornos';
     ...
     */
    routes() {
        //Rutas de equivalencias y retornos
        this.app.use( this.equivalenciaPath, require('../routes/equivalencias.routes'));
        this.app.use( this.retornoPath, require('../routes/retornos.routes'));
    }
